...
/* themes/contrib/tara/templates/navigation/pager.html.twig */
class __TwigTemplate_77a648f863f9c2340850ba9a77474b9c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["items"] ?? null)) {
            // line 34
            echo "  <nav class=\"pager pager-full\" role=\"navigation\" aria-labelledby=\"";
    ...
    <ul class=\"pager__items js-pager__items pager-items\">
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["items"] ?? null), "first", [], "any", false, false, true, 38)) {
                // line 39
                echo "        <li class=\"pager__item pager__item--first pager-item\">
          <a href=\"";
                // line 40
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["items"] ?? null), "previous", [], "any", false, false, true, 47)) {
                // line 48
                echo "        <li class=\"pager__item pager__item--previous pager-item pager-item-previous\">
          <a href=\"";
                // line 49
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["ellipses"] ?? null), "previous", [], "any", false, false, true, 56)) {
                // line 57
                echo "        <li class=\"pager__item pager__item--ellipsis pager-item pager-item-previous\" role=\"presentation\">&hellip;</li>
      ";
            }
            // line 59
            echo "      ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["item"]) {
                // line 61
                echo "        <li class=\"pager-item pager__item";
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["ellipses"] ?? null), "next", [], "any", false, false, true, 76)) {
                // line 77
                echo "        <li class=\"pager__item pager__item--ellipsis pager-item pager-item-next\" role=\"presentation\">&hellip;</li>
      ";
            }
            // line 79
            echo "      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 80)) {
                // line 81
                echo "        <li class=\"pager__item pager__item--next pager-item pager-item-next\">
          <a href=\"";
                // line 82
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["items"] ?? null), "last", [], "any", false, false, true, 89)) {
                // line 90
                echo "        <li class=\"pager__item pager__item--last pager-item\">
          <a href=\"";
                // line 91
...
";
    ...
    {
        return "themes/contrib/tara/templates/navigation/pager.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/tara/templates/navigation/pager.html.twig", "/var/www/html/evertacademy-registerform/themes/contrib/tara/templates/navigation/pager.html.twig");
    }
