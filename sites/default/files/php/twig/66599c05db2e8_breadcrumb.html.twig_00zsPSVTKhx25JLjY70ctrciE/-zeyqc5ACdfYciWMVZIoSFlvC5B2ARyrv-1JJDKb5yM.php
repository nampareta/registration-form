...
class __TwigTemplate_016cac66c646b7cb8b06d49a5c247f23 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 15)) {
                    ...
                    echo "</a><i class=\"icon-angle-right breadcrumb-item-seperator\" aria-hidden=\"true\"></i>
        ";
                } else {
                    // line 18
                    echo "          ";
...
";
    ...
    {
        return new Source("", "themes/contrib/tara/templates/navigation/breadcrumb.html.twig", "/var/www/html/evertacademy-registerform/themes/contrib/tara/templates/navigation/breadcrumb.html.twig");
    }
